...
- 阶段：知识恢复强化期。
- 旧知识：闭卷5题诊断 → 按成绩定点补学 → 第二组验证；新知识先学再练。
- 核心预算A日60～75分钟，B日35～45分钟，C日15～20分钟；周末有空90～120分钟分两块。工作日另有可选机动池，每块10～30分钟，额外建议约60分钟，逐块明确调用。
- 核心完成决定当天完成状态；机动没做或工作打断不算失败、不顺延。说“继续”只下发下一块；保护后续闭卷验证，每天原则上最多开启一个新主知识点。
- KPI：闭环完成 → 能识别并口述方法 → 正确率。
- 保留A/B/C降级、计划休息、不补课、不制造训练债务。已掌握复习进入10～15题计时；9月30日阶段检查，10月转混合与限时。
